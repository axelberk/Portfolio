      ...
      <TimelineItem>
        ...
        <TimelineContent sx={textStyle}>
          <div className="event-item">
            ...
            <p className="event-description">Started working at <span style={{color:"aquamarine"}}>foodora</span>. Then a fast-growing food delivery company, it has since become the national leader in the market with a highly recognizable brand. </p>
          </div>
        </TimelineContent>
      </TimelineItem>
      <TimelineItem>
